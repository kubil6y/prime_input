...
export class Input {
    ...
    public static dispose(): void {
        ...
        window.removeEventListener("keypress", Input.handleKeypress);
    }

    // KeyDown and KeyUp are frame based inputs.
    // They should be cleanup at the of the frame in game loop
    // WARNING: Call this function at the end of your game loop.
    ...
    public static handleKeydown(e: KeyboardEvent): void {
        ...
        Input._keyupMap.set(KeyCodeReverseMap[e.key], false);
    }
